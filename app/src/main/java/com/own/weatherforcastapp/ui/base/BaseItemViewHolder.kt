...
import com.own.weatherforcastapp.di.component.DaggerViewHolderComponent
...
import com.own.weatherforcastapp.utils.display.Toaster
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as WeatherForecastApplication).applicationComponent)
